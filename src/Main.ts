...
class Main extends egret.DisplayObjectContainer {
    ...
    private createGameScene():void {
      ...
      bg1.width=stageW;bg1.height=stageH;
...
class Player{
    ...
    move(targetX : number, targetY  : number){
        ...
        egret.Tween.get(this.main.role).to( {x: this.playerTargetX, y:this.playerTargetY}, 500, egret.Ease.circIn );
    ...
    idle(){
        ...
        this.main.role.gotoAndStop(1);
            ...
            idelRole.to( {x: this.playerTargetX - 50, y:this.playerTargetY - 50}, 100, egret.Ease.circIn );
            idelRole.to( {x: this.playerTargetX , y:this.playerTargetY}, 100, egret.Ease.circIn );
            idelRole.to( {x: this.playerTargetX + 50, y:this.playerTargetY + 50}, 100, egret.Ease.circIn );
            idelRole.to( {x: this.playerTargetX, y:this.playerTargetY }, 100, egret.Ease.circIn );
